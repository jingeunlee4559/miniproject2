...
function Login() {
    ...
    const handleLogin = (e) => {
        ...
        try {
            ...
            axios
                .post('/api/login', { mem_id: username, mem_pw: password })
                .then((response) => {
                        ...
                        <Row className="justify-content-md-center">
                            <Col lg={8} md={12} sm={12} className="login-form-container">
                                <div className="text-center mt-2">
                                    <img src="img\mini2-login.png" alt="Read Fit 로고" className="login-logo" />
                                </div>
                                ...
                                <Form onSubmit={handleLogin}>
                                    <InputGroup className="mb-3 w-75">
                                        ...
                                        <Form.Control type="text" placeholder="아이디" className="input-field" value={username} onChange={(e) => setUsername(e.target.value)} />
                                    </InputGroup>
                                    ...
                                    <InputGroup className="mb-3 w-75">
                                        ...
                                        <Form.Control type="password" placeholder="비밀번호" className="input-field" value={password} onChange={(e) => setPassword(e.target.value)} />
                                    </InputGroup>
                                ...
                                <div className="text-center mt-4">
                                    <Nav className="me-auto justify-content-center">
                                        <Nav.Link onClick={() => navigateTo('/FindIDPW')} className="nlink">
                                            아이디/비밀번호 찾기
                                        </Nav.Link>

                                        <Nav.Link onClick={() => navigateTo('/Register')} className="nlink">
                                            회원가입
                                        </Nav.Link>
                                    </Nav>
                                </div>
