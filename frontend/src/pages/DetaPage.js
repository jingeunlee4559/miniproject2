...
const DetailPage = () => {
  ...
  const mockData = [
    ...
    { board_seq: 10, board_title: "울릉도, 독도 여행 준비 팁", board_at: "2025-08-10T20:20:00", board_views: 220, writer: "바다탐험가", content: "울릉도, 독도 여행 전 반드시 준비해야 할 것들..." },
  ];
        ...
        <div className="detail-container my-5">
          {seq === '0' && !isEditing && (
            <Row className="button-group">
              ...
              <Button  variant='warning' className="btn me-2">
                </Button>
                <Button 
                  onClick={deletepost} 
                  variant='danger' 
