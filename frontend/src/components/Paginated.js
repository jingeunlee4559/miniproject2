    ...
    return (
        <>
            ...
            <div className="pagination-container d-flex justify-content-center align-items-center mt-3">
                <ButtonGroup>
                    {/* Pagination buttons */}
                    <Button onClick={() => gotoPage(0)} disabled={!canPreviousPage} variant="primary" size="sm">
                        {'<<'}
                    </Button>
                    <Button onClick={() => previousPage()} disabled={!canPreviousPage} variant="primary" size="sm">
                        이전
                    </Button>
                    {getPageNumbers().map((number) => (
                        <Button
                            ...
                            size="sm"
                            style={{
                                backgroundColor: pageIndex === number ? '#6DD2FF' : 'lightgray',
                    ...
                    <Button onClick={() => nextPage()} disabled={!canNextPage} variant="primary" size="sm">
                        다음
                    </Button>
                    <Button onClick={() => gotoPage(pageCount - 1)} disabled={!canNextPage} variant="primary" size="sm">
                        {'>>'}
                    </Button>
                </ButtonGroup>
            </div>
