...
public class CategoryService {
    ...
    public List<CategorySimpleResponse> findAll() {
        return categoryMapper.findAll();
    }

    public List<CategorySimpleResponse> findByRegion1Id(Long id) {
        return categoryMapper.findByRegion1Id(id);
    }

    public List<CategorySimpleResponse> findByRegion2Id(Long id) {
        return categoryMapper.findByRegion2Id(id);
    }

    public Optional<CategoryDetailResponse> findById(Long id) {
        return categoryMapper.findById(id);  // Optional을 그대로 반환
    }

    @Transactional
    public void incrementViewCount(Long id) {
        categoryMapper.incrementViewCount(id);
    }
